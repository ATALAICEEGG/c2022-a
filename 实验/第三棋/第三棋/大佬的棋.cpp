...
void board()
{
	...
	outtextxy(800, 200, L"悔 棋");
	outtextxy(800, 300, L"重 来");
	outtextxy(800, 400, L"后 手");
	outtextxy(800, 500, L"退 出");
	settextcolor(RED);
	settextstyle(15, 0, _T("宋体"));
	outtextxy(2, 2, L"作者：杨秀杰");
}
//下棋
...
void over(int x)
{
	...
	settextstyle(50, 24, L"宋体");
	settextcolor(RED);    //字体颜色
	if (x == 1)
	{
		outtextxy(100, 50, L"平局");
	}
	else if (x == 2)
	{
		outtextxy(100, 50, L"电脑获胜");
	}
	else if (x == 3)
	{
		outtextxy(100, 50, L"玩家获胜");
	}
	settextcolor(WHITE);
	outtextxy(50, 200, L"返回游戏界面");
	outtextxy(80, 300, L" 结束游戏");
